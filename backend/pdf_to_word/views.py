...
def list_word_files(request):
    files = ConversionRecord.objects.values('id', 'word_file_name', 'timestamp', 'status')
...
def delete_word(request, pk):
    try:
        ...
        word_file_path = os.path.join(settings.MEDIA_ROOT, conversion_record.word_file_name)
